...
class QwenVLDataCollator:
    ...
    def __call__(self, batch):
        ...
        full_inputs = self.processor(
            text=full_texts, images=images, return_tensors="pt", padding=True, truncation=bool(self.max_text_tokens), max_length=self.max_text_tokens,
        )
        prompt_inputs = self.processor(
            text=prompts, images=images, return_tensors="pt", padding=True, truncation=bool(self.max_text_tokens), max_length=self.max_text_tokens,
        )
...
def main():
    ...
    collator = QwenVLDataCollator(processor, image_size=args.image_size, max_text_tokens=args.max_text_tokens,)
